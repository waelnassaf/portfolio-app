            ...
            <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[25rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
                <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
                    ...
                    <Link
                        ...
                        font-medium rounded-lg text-sm px-5 py-2.5 me-2 my-3
                        dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700
                        dark:border-gray-700 w-1/2 flex items-center justify-center
                        ${
                            title === "Almas"
                        ...
                        target="_blank"
                    >
                        <span>{title === "Almas" ? "Soon" : "Preview"}</span>
                        <GrFormNextLink className="text-2xl opacity-70 transition-all hover:translate-x-1" />
                    </Link>
                </div>
